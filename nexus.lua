    ...
    function Win:Tab(cfg)
        ...
        function Tab:Button(btnCfg)
            ...
            local nameLbl = Create("TextLabel", {
                ...
                Position = UDim2.new(0, 48, 0, bDesc ~= "" and 8 or 0.5),
                Text = bName,
                TextColor3 = Theme.Text,
                TextSize = 13,
                Font = Theme.FontSemi,
    ...
    Callback = function()
        ...
        Nexus:Verify({
            ...
            Callback = function()
                ...
                -- Tab Aimbot
                local AimTab = Win:Tab({ Name = "Aimbot", Icon = "🎯" })
                ...
                -- Tab ESP
                local EspTab = Win:Tab({ Name = "ESP", Icon = "👁️" })
                EspTab:Toggle({ Name = "ESP Joueurs", Icon = "👁️", Default = false, Callback = function(v) end })
                EspTab:Toggle({ Name = "ESP Noms",    Icon = "◈",  Default = true,  Callback = function(v) end })
